...
CREATE TABLE IF NOT EXISTS Refrigerators (
    RefrigeratorID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    Name VARCHAR(100) NOT NULL,
    Location VARCHAR(100) NOT NULL DEFAULT '',
    MQTT_Topic VARCHAR(50) NOT NULL,
    Temperature_Threshold DECIMAL(5,2) DEFAULT 15.00,
    Humidity_Threshold DECIMAL(5,2) DEFAULT 40.00,
    Fan_Status ENUM('ON','OFF') DEFAULT 'OFF',
    Is_Active TINYINT(1) DEFAULT 1,
    UNIQUE KEY uk_mqtt_topic (MQTT_Topic)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT IGNORE INTO Refrigerators (RefrigeratorID, Name, Location, MQTT_Topic, Temperature_Threshold, Humidity_Threshold) VALUES
(1, 'Refrigerator 1', 'Store Front', 'Frig1', 15.00, 40.00),
(2, 'Refrigerator 2', 'Store Back',  'Frig2', 15.00, 40.00);
...
CREATE TABLE IF NOT EXISTS TemperatureAlerts (
    ...
    AlertType ENUM('TEMPERATURE_HIGH','HUMIDITY_HIGH') NOT NULL,
    Message TEXT,
    ...
    KEY idx_refrigerator (RefrigeratorID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
