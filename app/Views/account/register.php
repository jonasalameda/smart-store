...
<main class="main-content">
  <div class="container py-5" style="max-width:520px;">
    <div class="text-center mb-4">
      ...
      <p class="text-muted small mb-0">Session-only demo — rename fields anytime.</p>
    </div>
    <?php if ($error): ?>
        ...
        <form method="post" action="<?= htmlspecialchars($base) ?>/account/register">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input class="form-control" name="first_name" required placeholder="Ada">
            </div>
            <div class="col-md-6">
              <label class="form-label fw-semibold">Last name</label>
              <input class="form-control" name="last_name" required placeholder="Lovelace">
            </div>
          </div>
          <div class="mb-3 mt-1">
            <label class="form-label fw-semibold">Email</label>
            <input class="form-control" type="email" name="email" required autocomplete="email" placeholder="you@example.com">
          </div>
          <div class="mb-4">
