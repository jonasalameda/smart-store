...
<head>
  ...
  <style>
    ...
    .notification-card:hover {
      box-shadow: 0 0 15px rgba(110, 192, 255, 0.3);
    }
    ...
    .notifications-empty .icon { font-size: 64px; margin-bottom: 20px; opacity: 0.5; }
  </style>
</head>
<body>
  ...
  <div class="sidebar expanded" id="sidebar">
    <a href="<?= APP_BASE_URL ?>/"><span class="icon">🏠</span><span>Dashboard</span></a>
    <a href="<?= APP_BASE_URL ?>/notifications" class="active"><span class="icon">🔔</span><span>Notifications</span></a>
    ...
    <div class="notifications-container">
      <?php if (empty($notifications)): ?>
        <div class="notifications-empty">
          ...
          <p style="font-size: 14px;">When you add customers or receive alerts, they'll show up here.</p>
        </div>
      <?php else: ?>
